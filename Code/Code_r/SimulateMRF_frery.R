...
filtered.Classes1 <- MedianFilter(Classes1, 21)
...
## Now with MM operations
library(mmand)

disc11 <- shapeKernel(c(11,11), type="disc")

plot(imagematrix(equalize(Classes1)))
plot(imagematrix(equalize(opening(Classes1, shapeKernel(c(5,5), type="disc")))))
