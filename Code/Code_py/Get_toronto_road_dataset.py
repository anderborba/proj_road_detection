...
if __name__ == "__main__":
    ...
    URL_VALID_IMG = "https://www.cs.toronto.edu/~vmnih/data/mass_roads/valid/sat/index.html"
    URL_VALID_GT  = "https://www.cs.toronto.edu/~vmnih/data/mass_roads/valid/map/index.html"
    ...
    BASE_DIR = os.path.expanduser("~/MEGA/github/proj_road_detection/Data/road_segmentation/")

    dirs = [
        BASE_DIR + "training/input/",
        BASE_DIR + "training/output/",
        BASE_DIR + "validation/input/",
        BASE_DIR + "validation/output/",
    ...
    html_url_parser(url=URL_TRAIN_IMG, save_dir=BASE_DIR + "training/input/")
    html_url_parser(url=URL_TRAIN_GT,  save_dir=BASE_DIR + "training/output/")

    html_url_parser(url=URL_VALID_IMG, save_dir=BASE_DIR + "validation/input/")
    html_url_parser(url=URL_VALID_GT,  save_dir=BASE_DIR + "validation/output/")

    html_url_parser(url=URL_TEST_IMG,  save_dir=BASE_DIR + "testing/input/")
    html_url_parser(url=URL_TEST_GT,   save_dir=BASE_DIR + "testing/output/")
